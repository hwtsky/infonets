# relu2.py
"""
Created on Fri Jun  1 23:08:32 2018
...
PARAMS_RELU2 = OrderedDict()
PARAMS_RELU2['eps'] = 1e-6
PARAMS_RELU2['seed'] = -1
PARAMS_RELU2['max_epoches'] = 200
PARAMS_RELU2['lr'] = 0.4
PARAMS_RELU2['minlr'] = 1e-4
PARAMS_RELU2['tao'] = 0.9
PARAMS_RELU2['momentum_decay']= 0.9
PARAMS_RELU2['save_history'] = False#True #
PARAMS_RELU2['display'] = 50 #0 # 1, ... # None
PARAMS_RELU2['beta'] = 3.0
PARAMS_RELU2['bias_requires_grad'] = True
PARAMS_RELU2['isnorm'] = True
PARAMS_RELU2['isrow'] = False
PARAMS_RELU2['isorth'] = True
PARAMS_RELU2['orthNum'] = None#50 #
PARAMS_RELU2['ith_cls'] = 0
PARAMS_RELU2['balance_factor'] = 0.5
PARAMS_RELU2['margin'] =  0.5
PARAMS_RELU2['E0'] = None
PARAMS_RELU2['weight_end'] = None
PARAMS_RELU2['bias_start'] = None
PARAMS_RELU2['update_method'] = 'update' # 'update1' #


def relu2(input, C=None, bias=None, params=None, **kwargs):
    ...
    p = copy_params_in(def_params=PARAMS_RELU2,
...
#    ipdb.set_trace()
    ...
    return f(relu2_grad, 'ReLU2Grad', input, C, bias, p, ith_cls, R, margin, E0)
